...
public class UserRestControllerV1 {
    ...
    public ResponseEntity<List<UserDto>> getPageUsers(@PathVariable(name = "page") Integer page, @PathVariable(name = "page") Integer offset, @PathVariable(name = "sortBy") String sortBy){
